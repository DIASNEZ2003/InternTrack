            ...
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col-reverse md:flex-row gap-8">
                <form onSubmit={saveProfile} className="flex-1 flex flex-col gap-5">
                  ...
                  <div className="pt-2">
                    <button type="submit" disabled={isSaving} className={`px-4 py-2 rounded-md font-bold text-[12px] text-white transition-colors ${theme.primary}`}>
                  ...
                  <div className={`relative group inline-block rounded-full w-[200px] h-[200px] overflow-hidden border-4 ${borderDivider} ${isDarkMode ? 'bg-black/20' : 'bg-gray-100'}`}>
                    {profileData.avatar_url ? (
                      ...
                      <div className={`w-full h-full flex items-center justify-center ${isDarkMode ? 'text-white' : theme.text}`}>
                        <svg className="w-24 h-24 opacity-60" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg>
                      </div>
                    )}
