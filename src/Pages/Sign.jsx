...
function Sign() {
  ...
  // NEW: State for hiding/showing passwords
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full px-4 py-2.5 pr-10 rounded border border-gray-200 focus:border-green-600 focus:ring-1 focus:ring-green-600 outline-none text-sm transition-colors placeholder-gray-400"
                />
                <button 
                  type="button" 
                  onMouseDown={(e) => e.preventDefault()} // Prevents the strong password rules from hiding when clicked
